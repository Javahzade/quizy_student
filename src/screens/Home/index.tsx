    ...
    <SafeAreaView style={styles.area}>
      <View>
        <Image
          ...
          source={require('../../assets/icons/Group8.png')}
        />
      </View>
      <View>
        <Image
          style={{marginLeft: 56, marginTop: -130}}
          source={require('../../assets/icons/Oval.png')}
        />
        <Image
          style={{marginLeft: 355, marginTop: -205}}
      ...
      <View style={styles.category}>
        ...
        <Image
          style={{marginLeft: 330, marginTop: -24}}
      ...
      <View style={styles.container}>
        <TouchableOpacity
          onPress={onclick}
          style={[styles.low, {backgroundColor: buttonColorLow}]}>
          <Text
            style={{
              color: '#6A5AE0',
              fontFamily: 'Poppins',
        ...
        <TouchableOpacity
          onPress={onPress}
          style={[styles.medium, {backgroundColor: buttonColorMedium}]}>
          <Text
            style={{
              color: '#6A5AE0',
              fontFamily: 'Poppins',
        ...
        <TouchableOpacity
          onPress={buttonColor}
          style={[styles.hard, {backgroundColor: buttonColorHard}]}>
          <Text
            style={{
              color: '#6A5AE0',
              fontFamily: 'Poppins',
      ...
      <View>
        <Text
          style={{fontSize: 16, color: 'white', marginLeft: 32, marginTop: 22}}>
          Choose type
        </Text>
      </View>
      <View style={styles.choosingtype}>
        ...
        <View>
          <TouchableOpacity style={styles.multiple}>
            <Text style={{fontSize: 18, fontWeight: '800', color: '#6A5AE0'}}>
              Multiple
            </Text>
          </TouchableOpacity>
        </View>
      ...
      <View style={{flexDirection: 'row', marginTop: -70}}>
        <View>
          ...
          <Image
            style={{marginTop: -230, marginLeft: 300}}
            source={require('../../assets/icons/Oval(1).png')}
          />
        </View>
        <TouchableOpacity>
